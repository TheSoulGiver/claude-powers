...
class MemorizeRequest(BaseModel):
    ...
    force_extract: bool = False  # Skip boundary detection, immediately extract memories
...
- assistant: Message from an AI assistant""",
    ...
    force_extract: Optional[bool] = Field(
        default=False,
        description="Skip boundary detection and immediately extract memories from this message",
    )
